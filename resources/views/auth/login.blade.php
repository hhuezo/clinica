        ...
        <div class="col-md-6" style="background-color: #e3e9f1; border-radius: 25px;">
            <div class="">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <div class="h-decor"></div>
                    <div class="form-group row" style="padding-left: 35%;" >

                     <center><a class="btn btn-hover-fill" href="{{ url('seguridad/user/create') }}" style="background-color: #4fb366; border-color: #4fb366;"><i class="icon-right-arrow"></i><span>Crear Cuenta</span><i class="icon-right-arrow"></i></a></center>   
