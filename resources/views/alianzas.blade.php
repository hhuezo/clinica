...
<body class="shop-page">
	...
	<div class="page-content">
		...
		<div class="section mt-0">
            <div class="text-center mb-2  mb-md-3 mb-lg-4"><br>
                <h1>Laboratorio Clínico Lister</h1>
                <div class="h-decor"></div><br>
            </div><div class="text-center"> <img src="{{ asset('dentco-html/images/Lab Lister.jpg') }}" class="img-thumbnail rounded mx-auto d-block" alt=""></div><br><br>
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="contact-map" id="googleMapContact0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.2188124808536!2d-89.20632138464005!3d13.705193302063003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f63308b576103d5%3A0x58e090551db29125!2sCl%C3%ADnica%20de%20Radiolog%C3%ADa%20y%20Ultrasonograf%C3%ADa%20Sosa%20-%20Guevara!5e0!3m2!1ses-419!2ssv!4v1652301797106!5m2!1ses-419!2ssv" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
							...
							<div class="row">
								<div class="col-md">
									...
									<ul class="icn-list-lg">
										<li><i class="icon-placeholder2"></i> Laboratorio Clínico Lister
											<br>25 Av Nte No 712 Condominio Gurdián de Nueda Ctgo a Clínicas Médicas
										</li>
									</ul><br>
								</div>
								<div class="col-md mt-3 mt-md-0">
									...
									<ul class="icn-list-lg">
										<li><i class="icon-telephone"></i>Telefono: <span class="theme-color"><span class="text-nowrap">2225 - 2723 / 7004 - 4475</span>
											</span>
											</span>
										</li>
								...
								<div class="col-md mt-3 mt-md-0">
									...
									<ul class="icn-list-lg">
										<li><i class="icon-clock"></i>
											<div>
												<div class="d-flex"><span>Lun-Vie</span><span class="theme-color">06:45 AM - 05:00 PM</span></div>
												<div class="d-flex"><span>Sabado</span><span class="theme-color">07:00 AM - 12:00 MD</span></div>
											</div>
										</li>
									</ul>
								</div>
		...
		<div class="section mt-0">
            <div class="text-center mb-2  mb-md-3 mb-lg-4"><br>
                <h1>Clínica de Radiología, Ultrasonografía e Imágenes Guidos-Zapata </h1>
                <div class="h-decor"></div><br>
            </div><div class="text-center"> <img src="{{ asset('dentco-html/images/Clinica de Radiología, Ultrasonografía e Imágenes. Guidos-Zapata.png') }}" class="img-thumbnail rounded mx-auto d-block" alt=""></div><br><br>
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="contact-map" id="googleMapContact0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.2188124808536!2d-89.20632138464005!3d13.705193302063003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f63308b576103d5%3A0x58e090551db29125!2sCl%C3%ADnica%20de%20Radiolog%C3%ADa%20y%20Ultrasonograf%C3%ADa%20Sosa%20-%20Guevara!5e0!3m2!1ses-419!2ssv!4v1652301797106!5m2!1ses-419!2ssv" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
						...
						<div class="container">
							<div class="row">
								<div class="col-md">
									...
									<ul class="icn-list-lg">
										<li><i class="icon-placeholder2"></i> Clínica de Radiología, Ultrasonografía e Imágenes Guidos-Zapata
											<br>25 Av. Norte N° 640 Clínicas Medicas, San Salvador
										</li>
									</ul><br>
								</div>
								<div class="col-md mt-3 mt-md-0">
