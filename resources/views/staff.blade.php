		...
		<div class="section page-content-first">
			...
			<div class="row">
				...
				<div class="col-sm">
					<div class="doctor-box text-center">
						<div class="doctor-box-photo">
							<a href="#"><img src="{{ asset('dentco-html/images/Dra.Jenny Amaya.png') }}" class="img-fluid" alt=""></a>
						</div>
						<!--<h5 class="doctor-box-name"><a href="#">Dr. William Gardner</a></h5>
                    <div class="doctor-box-position">Implantologist</div>-->
						<div class="doctor-box-text">
			...
			<div class="row">
				<div class="col-sm">
					<div class="doctor-box text-center">
						<div class="doctor-box-photo">
							<a href="#"><img src="{{ asset('dentco-html/images/draambar_sandoval.png') }}" class="img-fluid" alt=""></a>
						</div>
						<div class="doctor-box-text">
							<p class="text-justify">
